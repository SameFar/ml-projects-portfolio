...
def main():
    data_path = '/home/sameer/Documents/jupyter/ml-projects-portfolio/data/isl_housing.csv'
    ...
    print(f"Validation Target Set Accuracy: {accuracy_score(y_test, test_predictions):.4f}")
