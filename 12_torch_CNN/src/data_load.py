...
def get_train_val_loaders(val_split=0.2, batch_size=32):
    ...
    """
    train_dataset = datasets.ImageFolder(root=path/'seg_train'/'seg_train', transform=transformer)
...
def get_test_loader(batch_size=32):
    ...
    test_dataset = datasets.ImageFolder(root=path/'seg_test'/'seg_test', transform=transformer)
