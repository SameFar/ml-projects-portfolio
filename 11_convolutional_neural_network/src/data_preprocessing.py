...
def get_images(
    train_file_name="train-images.idx3-ubyte", test_file_name="t10k-images.idx3-ubyte"
):
    """
...
def get_labels(
    train_file_name="train-labels.idx1-ubyte", test_file_name="t10k-labels.idx1-ubyte"
):
    with open(MNIST_DIR / train_file_name, "rb") as f:
